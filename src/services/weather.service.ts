...
export default class weatherService {
    static getWeather = async (options: weatherOptions) => {
        ...
        const hoursTemps =
            weather.data.forecast.forecastday[daysFromToday].hour;
        // const day = hours_temp.find((temp: any) => temp.time.includes('15:00'));
        // const night = hours_temp.find((temp: any) =>
        //     temp.time.includes('22:00')
        // );
